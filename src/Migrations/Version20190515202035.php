 ...
 */
final class Version20190515202035 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE allergen (id INT AUTO_INCREMENT NOT NULL, image_id INT NOT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_25BF08CE3DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE assoc (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, menu_id INT DEFAULT NULL, image_id INT NOT NULL, quantity INT NOT NULL, is_dish TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_7B9337114584665A (product_id), INDEX IDX_7B933711CCD7E912 (menu_id), UNIQUE INDEX UNIQ_7B9337113DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
